...
public class AdminController {
    ...
    public String index(HttpServletRequest request) {
        ...
        request.setAttribute("categoryCount", blogCategoryService.getCategorysCount());
        request.setAttribute("blogCount", blogService.getBlogsCount());
        request.setAttribute("linkCount", friendLinkService.getFriendLinksCount());
        request.setAttribute("tagCount", blogTagService.getBlogTagsCount());
        request.setAttribute("commentCount", blogCommentService.getCommentsCount());
        return "admin/index";
    }
